...
const french = {
  ...
  goals: {
    ...
    panel_1:{
      title: "Expansion",
      description: "120+ familles ont reçu l'aide de Dieu Peut Charité depuis notre création en 2022. Avec votre aide, nous prévoyons d'étendre nos initiatives de don de nourriture au-delà des frontières de Port-au-Prince. Nous voulons ouvrir la livraison de repas à distance dans les zones rurales sans infrastructure de transport et ressources locales pour la disponibilité alimentaire. Notre objectif de croissance secondaire est de rendre les programmes pour les jeunes disponibles à Gonaives. Nous voyons l'intérêt de combler les écarts éducatifs dans les villes où la pénétration d'Internet est insuffisante.",
